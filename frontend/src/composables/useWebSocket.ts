...
export type WsMessage = StatusChangeMessage | OnBootChangeMessage | ServiceAddedMessage | ServiceRemovedMessage | SnapshotMessage | SessionExpiredMessage | NodeStatusChangedMessage | NodeRegistryChangedMessage
